...
var JenkinsPCTasj = require('../models/jenkinsPCTask');
...
function updateJenkinsTask(path_){
  var p = new Promise(function(resolve, reject){
    ...
    parseString(data, function (err, result) {
      ...
      jenkinsPCTaskDao.update({associationID:associationID},{pass:reportResult['passed'],fail:reportResult['failed'],status:'Done'},function(err,res){
               if(err){
